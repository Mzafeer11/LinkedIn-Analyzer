...
- llm_interface: Functions for interfacing with GitHub Models via OpenAI-compatible APIs
...
from modules.llm_interface import create_github_embedding, create_github_llm, change_llm_model
